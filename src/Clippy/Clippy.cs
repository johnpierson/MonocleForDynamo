...
using Frame = Clippy.Configurations.Frame;
...
namespace MonocleViewExtension.Clippy
{
    ...
    public class Clippy
    {
        ...
        /// </summary>
        private static string spriteResourceUri = "pack://application:,,,/MonocleViewExtension;component/Clippy/Resources/clippy.png";

        /// <summary>
        /// The URI for the animations json definition
        /// </summary>
        private static string animationsResourceUri = "pack://application:,,,/MonocleViewExtension;component/Clippy/Resources/animations2.json";
